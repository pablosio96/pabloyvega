      ...
      try {
        ...
        await resend.emails.send({
          ...
          html: `
            ...
            <body style="margin:0;padding:0;background-color:#ffff;font-family:'Meow Script',serif;">
              <div style="background-color:#ffff;padding:40px 16px;">
                <div style="background:#ffffff;max-width:560px;margin:0 auto;border-radius:8px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">

                  <!-- Header -->
                  <div style="background:#4A6FA5;padding:40px 32px;text-align:center;">
                  ...
                  <div style="padding:36px 32px 24px 32px;text-align:center;border-bottom:1px solid #ede8e5;">
                    <h2 style="margin:0 0 14px 0;font-family:Georgia,serif;font-size:24px;font-weight:normal;color:#4A6FA5;">
                      ¡Hola, ${nombre}!
                    </h2>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                      ...
                      <tr>
                        <td style="padding:10px 0;border-bottom:1px solid #ede8e5;vertical-align:top;">
                          <span style="font-family:Arial,Helvetica,sans-serif;font-size:11px;font-weight:bold;color:#4A6FA5;letter-spacing:0.1em;text-transform:uppercase;">Nombre</span>
                        </td>
                      ...
                      <tr>
                        <td style="padding:10px 0;border-bottom:1px solid #ede8e5;vertical-align:top;">
                          <span style="font-family:Arial,Helvetica,sans-serif;font-size:11px;font-weight:bold;color:#4A6FA5;letter-spacing:0.1em;text-transform:uppercase;">Acompañantes</span>
                        </td>
                        <td style="padding:10px 0;border-bottom:1px solid #ede8e5;text-align:right;vertical-align:top;">
                      ...
                      <tr>
                        <td style="padding:10px 0;border-bottom:1px solid #ede8e5;vertical-align:top;">
                          <span style="font-family:Arial,Helvetica,sans-serif;font-size:11px;font-weight:bold;color:#4A6FA5;letter-spacing:0.1em;text-transform:uppercase;">Autobús</span>
                        </td>
                        <td style="padding:10px 0;border-bottom:1px solid #ede8e5;text-align:right;vertical-align:top;">
                      ...
                      <tr>
                        <td style="padding:10px 0;vertical-align:top;">
                          <span style="font-family:Arial,Helvetica,sans-serif;font-size:11px;font-weight:bold;color:#4A6FA5;letter-spacing:0.1em;text-transform:uppercase;">Preferencias</span>
                        </td>
                  ...
                  <!-- Footer -->
                  <div style="background:#4A6FA5;padding:24px 32px;text-align:center;">
                    ...
                    <img src="https://pabloyvega.com/images/wedding/00_coche.png" alt="Coche" style="width:120px;max-width:100%;margin:0 auto;display:block;" />
                  </div>
